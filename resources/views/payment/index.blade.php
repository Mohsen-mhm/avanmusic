...
@section('content')
    ...
    <div class="row" dir="rtl">
        <div class="col-md-6 d-flex flex-column justify-content-center align-items-center text-light mt-5">
        ...
        <div class="col-md-4 d-flex flex-column justify-content-center align-items-center text-light mt-5">
            <p>عملیات:</p>
