...
@section('content')
    <div class="container my-5" dir="rtl">
        <div class="d-flex justify-content-end mb-4">
            <a href="{{ route('admin.playlists.index') }}" class="btn btn-sm btn-secondary w-auto">بازگشت</a>
        </div>
                        ...
                        @if(! $isAvailableInPlaylist)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form
                                        action="{{ route('admin.playlists.add', ['playlist' => $playlist->id, 'song' => $song->id]) }}"
                    ...
                    @foreach($playlist->songs as $song)
                        <tr>
                            ...
                            <td>
                                ...
                                <form
                                    action="{{ route('admin.playlists.remove', ['playlist' => $playlist->id, 'song' => $song->id]) }}"
                                    method="POST" class="d-none"
                                    id="song-{{ $song->id }}">
                                    @csrf
                                </form>
